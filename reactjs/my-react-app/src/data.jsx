...
// function Mains() {
//   return(
//   <div style={{display:"flex",gap:"10px",backgroundColor:"black",flexWrap:"wrap",justifyContent:"center"}}>
//     {products.map((a,b)=>{return(
//         <div style={{backgroundColor:"blue",display:"flex",flexDirection:"column",width:"250px"}}>
//         <img src={a.image} alt={a.price}/>
//         <div style={{display:"flex",justifyContent:"space-between"}}>
//         <h1>{a.model}</h1>
//         <p style={{fontSize:"20px",fontWeight:"30px"}}>{a.price}</p>
//         </div>
    ...
    <table>
        ...
        {products.map((a,b)=>{return(
            <tr>
                <td>{a.id}</td>
                <td>{a.title}</td>
                <td><img src={a.image} alt={a.title} style={{height:"10vh"}}></img></td>
                <td>{a.price}</td>
                <td>{a.description}</td>
                <td>{a.brand}</td>
                <td>{a.model}</td>
